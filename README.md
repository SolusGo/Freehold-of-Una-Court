...
- The two civilizations currently share Dawn of Man artwork, map, leader portrait, and base-game unit models; each now has its own emblem, flag alpha, and Trentrouls unit portrait.
